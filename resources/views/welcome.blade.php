...
<body class="antialiased">
    <div
        ...
        @foreach (app()->get('locales') as $item)
            <a href="{{ route('changelocale', $item) }}"
                class="absolute top-0 right-0 mt-4 mr-1 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">{{ $item }}</a>
        @endforeach
